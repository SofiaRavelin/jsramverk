...
const Me = () => {
        return (
            ...
            <p>Jag heter Sofia Ravelin. Född och uppvuxen i Sollentuna, Stockholm och numera boende i Eksjö, Småland med man och två barn. Jag har jobbat inom förskola, i butik och som receptionist. I det akademiska bagaget har jag läst ett tekniskt basår samt lite pedagogik. I medalj har jag genomfört en tjejklassiker och GMU.</p>
            </div>
        );
};
